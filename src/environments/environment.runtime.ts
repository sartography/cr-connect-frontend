...
export const environment: AppEnvironment = {
  ...
  production: _has(ENV, 'production', '$PRODUCTION') ? (ENV.production === 'true') : true,
  ...
  sentryEnvironment: _has(ENV, 'sentryEnvironment', '$SENTRY_ENVIRONMENT') ? ENV.sentryEnvironment : "local",
};
